        ...
        <div className="px-4 py-6 sm:px-0">
          <div className="max-w-3xl mx-auto">
            <div className="flex items-center mb-4">
              ...
              <div>
                <h1 className="text-3xl font-bold mb-1">Hrushikesh Ambike</h1>
              ...
              <div className="border-t border-gray-200 px-4 py-5 sm:p-0">
                <dl className="sm:divide-y sm:divide-gray-200">
                  <div className="py-4 sm:py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                    ...
                    <dd className="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">
                      Led a team of 5 to develop a web application using React
                      and Django, which was deployed to production and used by
                      over 10,000 users.
                    </dd>
                  </div>
                  <div className="py-4 sm:py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                  ...
                  <div className="py-4 sm:py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                    ...
                    <dd className="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">
                      Completed a 3-month internship at XYZ company, where I
                      developed and maintained their e-commerce website using
                      React and Redux.
                    </dd>
                  </div>
                </dl>
