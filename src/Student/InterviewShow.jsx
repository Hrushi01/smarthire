...
function InterviewShow() {
  ...
  return (<>{
    switchWindow ? (    <div className="flex flex-col md:flex-row h-screen">
    <div className="bg-gray-200 w-full md:w-1/2 h-100 md:h-auto flex items-center justify-center">
      <Extra switchWindow={switchWindow} setSwitchWindow={setSwitchWindow} camRefresh={camRefresh} setCamREfresh={setCamREfresh}/>
    </div>
    <div className="bg-white w-full md:w-1/2 h-screen md:h-auto flex flex-col justify-between p-4">
      <div>
        <div className="text-right">
          <Timer duration={20 * 60}  switchWindow={switchWindow} setSwitchWindow={setSwitchWindow} camRefresh={camRefresh} setCamREfresh={setCamREfresh}/>
        </div>
